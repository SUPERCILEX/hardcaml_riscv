...
module BayesianTage = struct
    ...
    module Update_counters = struct
      module I = struct
        type 'a t =
          ...
          ; controlled_allocation_throttler : 'a [@bits 7]
          ; random1 : 'a [@bits 32]
          ; random2 : 'a [@bits 32]
          ; random3 : 'a [@bits 32]
          ; random4 : 'a [@bits 32]
      ...
      module O = struct
        type 'a t =
          ...
          ; next_controlled_allocation_throttler : 'a [@bits 7]
          }
        [@@deriving sexp_of, hardcaml]
      end
      ...
      let create
        ...
        in
        controlled_allocation_throttler -- "controlled_allocation_throttler" |> ignore;
  ...
  let create
    ...
    let prediction_read_entries, retirement_read_entries =
      ...
      |> List.unzip
    in
    ignore prediction_read_entries;
    ignore retirement_read_entries;
    ignore prediction_tags;
    ignore retirement_tags;
    ignore prediction_bimodal_entry;
    ignore retirement_bimodal_entry;
  ...
  module Tests = struct
    ...
    module Update_counters = struct
      ...
      let%expect_test "Human" =
         ...
         *)
          inputs.update.valid := vdd;
          inputs.update.resolved_direction := gnd;
          inputs.update.branch_target := of_bit_string "00000000000000000000000100011100";
          List.iter2_exn
            [ "0000001", "11", "01"; "0000000", "01", "11"; "0000001", "01", "10" ]
            inputs.read_entries
            ~f:(fun (tag, num_takens, num_not_takens) entry ->
              entry.tag := of_bit_string tag;
              entry.counters.num_takens := of_bit_string num_takens;
              entry.counters.num_not_takens := of_bit_string num_not_takens;
              ());
          List.iter2_exn
            [ "0000000"; "0000000"; "0000000" ]
            inputs.tags
            ~f:(fun tag entry ->
            entry := of_bit_string tag;
            ());
          inputs.bimodal_entry.direction := vdd;
          inputs.bimodal_entry.hysteresis := vdd;
          inputs.controlled_allocation_throttler := of_bit_string "0001100";
          inputs.random1 := of_bit_string "01000110111010000100000001110000";
          inputs.random2 := of_bit_string "10101001110010010010001111111101";
          inputs.random3 := of_bit_string "11000100111101100001111111100101";
          inputs.random4 := of_bit_string "11100110111000010100110001100101";
          inputs.random5 := of_bit_string "00010011011010100011111011100101";
          next ();
          ());
        [%expect
          {|
          ((inputs
            ((clock 0) (clear 0)
             ...
             (tags (0000000 0000000 0000000))
             (bimodal_entry ((direction 1) (hysteresis 1)))
             (controlled_allocation_throttler 0001100)
             (random1 01000110111010000100000001110000)
             (random2 10101001110010010010001111111101)
             (random3 11000100111101100001111111100101)
             (random4 11100110111000010100110001100101)
             (random5 00010011011010100011111011100101)))
           (outputs
            ((next_entries
              (((tag 0000000) (counters ((num_takens 00) (num_not_takens 01))))
               ...
               ((tag 0000001) (counters ((num_takens 01) (num_not_takens 10))))))
             (next_bimodal_entry ((direction 1) (hysteresis 0))) (meta 0000)
             (next_controlled_allocation_throttler 0001110)))
           (internals
            ((allocate 1) (allocation_bank 00) (allocation_bank_mask 011)
             (allocation_decay_range 000) (bank_used_for_prediction 11)
             (controlled_allocation_throttler_0 0001100) (end_allocation_bank 01)
             (end_allocation_bank_mask 100) (end_allocation_bank_valid 1)
             (first_hitter_bank 01) (first_hitter_mask 101) (gnd 0)
             (hitter_after_prediction_bank 11) (mhc 0)
             (next_controlled_allocation_throttler_0 0001110) (next_meta 0000)
             (randoms$1 01000110111010000100000001110000)
             (randoms$2 10101001110010010010001111111101)
             (randoms$3 11000100111101100001111111100101)
             (randoms$4 11100110111000010100110001100101)
