...
module BayesianTage = struct
  ...
  struct
            ...
            let update
              ...
              (next_folded_history
               ...
               let next =
                 ...
                 in
                 let tail_entry =
                   let tail = ue pointer +:. original_length in
                   let tail =
                     mux2
    ...
    module Update_counters = struct
      ...
      let create
        ...
        in
        let next_controlled_allocation_decay =
          wire (Int.floor_log2 (Params.controlled_allocation_decay_max + 1))
          -- "next_controlled_allocation_decay"
        in
        let controlled_allocation_decay =
          (next_controlled_allocation_decay
           |> reg ~enable:valid (Reg_spec.create ~clock ~clear ()))
        ...
        let decay_vector =
          let maybe_decay_on_allocation =
            ...
            &:
            let min_dp = 3 in
            uresize (sel_bottom random5 min_dp) (width controlled_allocation_decay)
            >=: srl
                  controlled_allocation_decay
                  (Int.floor_log2 (Params.controlled_allocation_decay_max + 1) - min_dp)
          in
          List.map2_exn
  ...
  module Params = struct
    type t =
      ...
      ; controlled_allocation_decay_max : int
  ...
  let create
    ...
    ~params:
      ...
      ; controlled_allocation_decay_max
  ...
  module Tests = struct
    module Params = struct
      ...
      let controlled_allocation_decay_max = 63
    ...
    module Update_history : sig end = struct
      ...
      module Model = struct
        ...
        let init () =
          ...
          ; branch_history =
              Array.create
                ~len:Params.(largest_branch_history_length + instruction_window_size)
                0
          ; jump_history =
              Array.create ~len:Params.(jump_history_length + instruction_window_size) 0
          ...
          then (
            let _update_pointers =
              ...
              update_pointer
                ...
                ~max:(Array.length branch_history);
              update_pointer ~ptr:jump_history_pointer ~max:(Array.length jump_history);
              ()
            in
            let _insert =
              Array.set
    ...
    module Update_counters = struct
      ...
      module Model = struct
        ...
        let update
          ...
          { meta; cat; cd; random1; random2; random3; random4; random5 }
          =
            ...
            then (
              ...
              while !i >= 0 do
                ...
                then (
                  ...
                  cd := !cd + 6 - (!mhc * 5);
                  cd := min Params.controlled_allocation_decay_max (max 0 !cd);
                  i := -1;
                  ())
              done;
              ());
