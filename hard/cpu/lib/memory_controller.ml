  ...
  let create
    ...
    ; segment =
        { Segment.read_data =
            ...
            |> reg ~enable:load (Reg_spec.create ~clock ~reset ())
        ; error =
            [ load_instruction
  ...
  let read_data activator =
    mux
      (let activations = List.map segments ~f:activator in
       ...
       |> List.reduce_exn ~f:( |: )
       |> reg
            ~enable:(List.reduce_exn activations ~f:( |: ))
...
module Tests = struct
  ...
  let%expect_test "Basic" =
    ...
    [%expect
      {|
      (((clock 0x0) (reset 0x0) (load_instruction 0x0) (load 0x0) (store 0x0)
      ...
      (((clock 0x0) (reset 0x0) (load_instruction 0x0) (load 0x0) (store 0x1)
        (program_counter 0x100000) (data_address 0x7fffffe0) (data_size 0x2)
        (signed 0x0) (write_data 0xdeadbeef)
        (uart ((write_done 0x0) (read_data 0x0) (read_done 0x0))))
       ((instruction 0x0) (read_data 0x0) (error 0x0)
      ...
      (((clock 0x0) (reset 0x0) (load_instruction 0x0) (load 0x1) (store 0x0)
        (program_counter 0x100000) (data_address 0x7fffffe0) (data_size 0x2)
        (signed 0x0) (write_data 0xdeadbeef)
        (uart ((write_done 0x0) (read_data 0x0) (read_done 0x0))))
      ...
      (((clock 0x0) (reset 0x0) (load_instruction 0x1) (load 0x0) (store 0x0)
        (program_counter 0x100000) (data_address 0x100000) (data_size 0x2)
        (signed 0x0) (write_data 0xdeadbeef)
        (uart ((write_done 0x0) (read_data 0x0) (read_done 0x0))))
  ...
  let%expect_test "Overlapping ops" =
    ...
    [%expect
      {|
      --------------------------------------------
      (((clock 0x0) (reset 0x0) (load_instruction 0x1) (load 0x1) (store 0x1)
      ...
      (((clock 0x0) (reset 0x0) (load_instruction 0x1) (load 0x1) (store 0x0)
        (program_counter 0x100200) (data_address 0x100000) (data_size 0x2)
        (signed 0x0) (write_data 0xdeadbeef)
        (uart ((write_done 0x0) (read_data 0x0) (read_done 0x0))))
      ...
      (((clock 0x0) (reset 0x0) (load_instruction 0x0) (load 0x1) (store 0x1)
        (program_counter 0x100200) (data_address 0x100000) (data_size 0x2)
        (signed 0x0) (write_data 0xdeadbeef)
        (uart ((write_done 0x0) (read_data 0x0) (read_done 0x0))))
       ((instruction 0xdeadbeef) (read_data 0xdeadbeef) (error 0x0)
      ...
      (((clock 0x0) (reset 0x0) (load_instruction 0x1) (load 0x0) (store 0x1)
        (program_counter 0x100200) (data_address 0x100000) (data_size 0x2)
        (signed 0x0) (write_data 0xdeadbeef)
        (uart ((write_done 0x0) (read_data 0x0) (read_done 0x0))))
       ((instruction 0x0) (read_data 0x0) (error 0x0)
